...
public class PatientRegistrationLocalServiceWrapper
	...
	*/
	...
	public java.util.List<com.liferay.patient.registration.model.PatientRegistration> getPatientSearchResults(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _patientRegistrationLocalService.getPatientSearchResults(firstName,
			lastName, optInFlag, andSearch, start, end);
	}
	...
	public java.util.List<com.liferay.patient.registration.model.PatientRegistration> getPatientSearchResultsForKeywords(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _patientRegistrationLocalService.getPatientSearchResultsForKeywords(keywords,
			andSearch, start, end);
	}
	...
	public int getPatientsSearchCount(java.lang.String firstName,
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _patientRegistrationLocalService.getPatientsSearchCount(firstName,
			lastName, optInFlag, andSearch);
	}
	...
	public int getPatientsSearchCountForKeywords(java.lang.String keywords,
		boolean andSearch)
		throws com.liferay.portal.kernel.exception.SystemException {
		return _patientRegistrationLocalService.getPatientsSearchCountForKeywords(keywords,
			andSearch);
	}
	...
	public java.util.List<com.liferay.patient.registration.model.PatientRegistration> getPatient(
		...
		throws com.liferay.patient.registration.NoSuchistrationException,
			com.liferay.portal.kernel.exception.SystemException {
		return _patientRegistrationLocalService.getPatient(groupId);
	}
	...
	public java.util.List<com.liferay.patient.registration.model.PatientRegistration> getPatientsByLastName(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _patientRegistrationLocalService.getPatientsByLastName(lastName);
	}
	...
	public com.liferay.patient.registration.model.PatientRegistration addNewPatient(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _patientRegistrationLocalService.addNewPatient(userId,
			firstName, lastName, address, city, state, zip, email, phoneNumber,
			dob, optIn, referringPractice, serviceContext);
	}
	...
	public com.liferay.patient.registration.model.PatientRegistration addNewPatientWithPCPInfo(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return _patientRegistrationLocalService.addNewPatientWithPCPInfo(userId,
			firstName, lastName, address, city, state, zip, email, phoneNumber,
			dob, optIn, referringPractice, pcpFirstName, pcpLastName,
			pcpAddress, pcpCity, pcpState, pcpZipCode, serviceContext);
	}
